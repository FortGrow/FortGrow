...
function Backdrop() {
  ...
  return (
    <div ref={ref} aria-hidden className="absolute inset-0 overflow-hidden">
      {/* Fundo em vídeo: dashboards 3D em movimento.
          `muted` + `playsInline` são o que permite o autoplay nos
          navegadores; `poster` cobre o intervalo até o primeiro quadro,
          para a tela nunca piscar preta. Fica atrás de um véu escuro —
          sem ele o formulário perde contraste sobre a animação. */}
      {/* Dois formatos: WebM/VP9 é ~18% menor e cobre Chrome, Edge e
          Firefox; o MP4/H.264 atende Safari e iOS. O navegador escolhe a
...
function LoginForm() {
  ...
  return (
    ...
    >
      ...
      <form
        onSubmit={onSubmit}
        className="glass glass-blur space-y-4 p-7"
        style={{
          ["--glass-radius" as string]: "28px",
          // vidro tingido no azul da marca, em vez do cinza neutro
          ["--glass-tint" as string]: "214 78% 66%",
          background:
            "linear-gradient(165deg, rgba(45,126,242,0.26), rgba(27,95,208,0.10) 55%, rgba(8,12,20,0.86))",
        }}
      >
    ...
    <div className="relative min-h-screen overflow-hidden bg-ink-950">
      ...
      <div className="relative z-10 grid min-h-screen lg:grid-cols-2">
        ...
        <div className="hidden flex-col justify-center px-14 xl:px-20 lg:flex">
          ...
          >
            Estruturamos o <span className={HIGHLIGHT}>marketing</span> que faz sua
            empresa vender.
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
